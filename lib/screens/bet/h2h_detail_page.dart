                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text('You ${widget.bet.status == 'ongoing' ? 'have an ongoing' : widget.bet.status + ' a'}',
                            style:
                        whiteTextStyle),
                        Text('£${widget.bet.amount.toStringAsFixed(2)}', style: GoogleFonts.roboto(color: Colors.white, fontSize:
                        30)),
                        Text('bet that', style: whiteTextStyle,),
                        Container(
                          child: Column(
                            children: [
                              SizedBox(
                  ...
                  Container(
                    ...
                    child: Transform.translate(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundColor: kBetSquadOrange,
                        child: CircleAvatar(
                          backgroundImage: _opponentProfilePicture != null ? NetworkImage(_opponentProfilePicture) : kUserPlaceholderImage,
                          radius: 48,
                        ),
                      ),
                    ),
