...
class EuroAssignmentPage extends StatefulWidget {
  static const ID = 'euro_assignments_page';
  final Bet bet;
  final String winnerEntryId;

  const EuroAssignmentPage({this.bet, this.winnerEntryId});

  @override
  _EuroAssignmentPageState createState() => _EuroAssignmentPageState();
}

class _EuroAssignmentPageState extends State<EuroAssignmentPage> {
  int initPosition = 0;
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              AllocationView(
                                                  userId: homeTeamPlayers[11]['userID'],
                                                  playerNumber: homeTeamPlayers[11]['number'],
                                                  playerName: homeTeamPlayers[11]['name']),
                                            ],
                                          ),
                                          SizedBox(height: 20),
                                        ],
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              AllocationView(
                                                  userId: awayTeamPlayers[11]['userID'],
                                                  playerNumber: awayTeamPlayers[11]['number'],
                                                  playerName: awayTeamPlayers[11]['name']),
