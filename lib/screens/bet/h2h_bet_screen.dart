                          ...
                          child: Column(
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(MdiIcons.tshirtCrew, color: HexColor(widget.match.homeShirtColor)),
                                  SizedBox(
                                    width: 5,
                                  ),
                                  Text(
                                    widget.match.homeTeamName + ' will',
                                    style: whiteTextStyle,
                                  )
                                ],
                              ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Icon(MdiIcons.tshirtCrew, color: HexColor(widget.match.awayShirtColor)),
                                  SizedBox(
                                    width: 5,
                                  ),
                                  Text(
